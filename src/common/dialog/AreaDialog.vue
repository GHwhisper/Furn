<template>
    ...
    >
        <el-form :model="form" label-position="top" :rules="rules" ref="ruleForm">
            <el-form-item label="收货人" prop="receiver"><el-input v-model.trim="form.receiver" /></el-form-item>
            ...
            <el-form-item><el-button type="warning" @click="submitForm('ruleForm')">保存收货地址</el-button></el-form-item>
        </el-form>
    </el-dialog>
</template>
        ...
        methods: {
            submitForm(formName) {  // 提交表单
                this.$refs[formName].validate(valid => {
                    if(valid) {
                        this.form.title = (this.form.title === '') ? this.form.receiver : this.form.title
